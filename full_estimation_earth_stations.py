...
# Create default body settings for "Sun", "Enceladus", "Saturn", and "Earth"
...
for station in station_names:
    viability_settings.append(observation.elevation_angle_viability(["Earth", station], np.deg2rad(5.0)))
# Check whether Enceladus or Saturn are occulting the signal
    viability_settings.append(observation.body_occultation_viability(["Orbiter", ""], "Earth"))
...
print("Number of parameters to estimate", nb_parameters)
...
plt.tight_layout()
plt.ylim([1294000000000, 1296000000000])
plt.show()
